...
from src.utils.eval_utils import model_fn, model_fn_eval, eval_dr_spaam, eval_person_flow
import src.utils.train_utils as tu
from src.utils.dataset import FlowDataset, FlowDatasetTmp, FlowDatasetTmp2, FlowDataset2
from src.utils.dataset_dr_spaam import create_test_dataloader, create_dataloader, DROWDataset
...
if __name__ == "__main__":
    ...
    #Testing
    print("Start testing")
    eval_person_flow(model, test_loader=test_loader, cfg=cfg, output_dir=root_result_dir)
